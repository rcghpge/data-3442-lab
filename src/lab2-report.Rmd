...
## Statistical Regreesion Methods: Data Summary
...
To render the lab report run the R code snippet below in R console. File output format for documentation can be changed.See link for more information: https://pkgs.rstudio.com/rmarkdown/reference/render.html
